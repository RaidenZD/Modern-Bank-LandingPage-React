  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute z-10 w-[80%] h-[80%] bottom-40 rounded-full white__gradient"></div>
        <div className="absolute z-20 w-[50%] h-[50%] right-20 bottom-20 blue__gradient"></div>
      </div>
